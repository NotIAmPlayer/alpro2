...
class Player():
    ...
    def update(self):
        ...
        pygame.draw.rect(screen, (255, 0, 0), (self.rect.x - camera.x, self.rect.y - camera.y, self.width, self.height), 2)
...
class NPC_config():
    def __init__(self):
        ...
        self.health             = [0, 3, 0]
        self.nogravity          = [True, False, True]
        self.noblockcollision   = [True, False, True]
        self.isWalker           = [False, False, False]
        self.weakTo             = [[], [], []]
